...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C7hRQj_e.mjs");
...
var manifest = {
	"10118e9a9b2b4c2c1d1c7075fa722adb162d85155d9275a0dd2d7ee540a93c43": {
		functionName: "translateTurn_createServerFn_handler",
		importer: () => import("./ai-DtOqsDe-.mjs")
	},
	"7af1eb60acda78dcf6b340c8addbd33bcede597c6c2f603d66f82eacccd4e27c": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Bt-emPIm.mjs").then((n) => n.t),
