...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Bt-emPIm.js
var router_Bt_emPIm_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DN71beiU.css";
var APP_NAME = "Fluister";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Private Dutch to Afrikaans interview HUD for AMD Ryzen AI Max machines."
			},
			{
				name: "theme-color",
				content: "#0c0c0b"
...
var $$splitComponentImporter = () => import("./routes-D_RzaNEN.mjs");
...
//#endregion
export { getRouter, router_Bt_emPIm_exports as t };
